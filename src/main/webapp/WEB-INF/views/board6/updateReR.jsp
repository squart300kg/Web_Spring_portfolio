...
<body>
 ...
 <form role="form" method="post" action='<%=request.getContextPath()%>/board6/updateRR?num=${num}&rnum=${rnum}&page=${page}'>
	...
	<div id="myModal" class="modal">
      ...
      <div class="modal-content">
           ...
           <input id="modalSubmit"  type="submit" class="btn btn-success"  value="SUBMIT" >
            ...
            <button  id="closePop" onclick="document.location.href='<%=request.getContextPath()%>/board6/read?num=${num}&page=${page}'"> Close </button>
