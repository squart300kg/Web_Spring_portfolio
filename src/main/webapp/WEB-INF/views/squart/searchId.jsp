...
<body>
<!-- 아이디 찾기 정보를 입력한 후 script의 alert정보를 띄워준 후 메인으로 이동 -->
<h1></h1>
<div class = "container">
...
<div class = "form-group">
	...
	<div class = "col-sm-2"></div>
		...
		<div class = "col-sm-4">
			<input type = "text" class="form-control" name = "name" maxlength="35" placeholder="EMAIL" value = "${name }"><br/>
			${noMatchingName }
		</div>
	</div>
	<div class = "form-group">
	<div class = "col-sm-2"></div>
		...
		<div class = "col-sm-4">
			<input type = "email" class="form-control" name = "email" maxlength="35" placeholder="NAME" value = "${email }"><br/>
			${noEmail }
		</div>
	</div>
	<div class = "form-group">
	<div class = "col-sm-2"></div>
		...
		<div class = "col-sm-4">
			...
			<button onclick="imgRefresh()" id="refreshBtn" class = "btn btn-success">새로고침</button>
