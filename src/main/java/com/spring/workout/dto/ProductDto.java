...
public class ProductDto {
	...
	public String toString() {
		return "ProductDto [product_id=" + product_id + ", product_kind=" + product_kind + ", product_title="
				+ product_title + ", product_price=" + product_price + ", product_count=" + product_count + ", brand="
				+ brand + ", product_image=" + product_image + ", product_content=" + product_content
