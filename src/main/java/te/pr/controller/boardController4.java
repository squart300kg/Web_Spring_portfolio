...
import te.pr.service.replyService4;
...
public class boardController4 {
	private static final Logger logger 
		= LoggerFactory.getLogger(boardController4.class);
	
	@Inject
	private BoardService4 service;
	
	@Inject
	private replyService4 Rservice;
...
//		
	...
	public String updateRR(@RequestParam("page") int page,@RequestParam("rnum") int rnum, @RequestParam("num") int num,
		...
		return "redirect:/board4/updateRR";
	}
