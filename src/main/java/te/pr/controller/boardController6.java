...
public class boardController6 {
	private static final Logger logger 
		= LoggerFactory.getLogger(boardController6.class);
...
//		
	...
	public String updateRR(@RequestParam("page") int page,@RequestParam("rnum") int rnum, @RequestParam("num") int num,
		...
		return "redirect:/board6/updateRR";
	}
